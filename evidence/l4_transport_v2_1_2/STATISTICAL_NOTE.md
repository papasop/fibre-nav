...
The reported `28/28` wins compare all unordered distances among eight transported endpoints with random-kernel-perturbed retraction controls. These 28 distances share endpoints and therefore are not independent Bernoulli trials. The added kernel perturbation was scale-matched to the direct-retraction displacement; the final control displacement was not explicitly norm-matched.
