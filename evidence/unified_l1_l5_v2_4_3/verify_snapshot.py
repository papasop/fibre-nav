...
assert summary["seeds_all_gates_pass"] == 2
assert summary["all_seeds_pass"] is False
assert summary["layer_pass_counts"] == {"L1": 3, "L2": 2, "L3": 2, "L4": 3, "L5": 3}
print("MFI unified L1-L5 v2.4.3 snapshot verified (2/3 full passes)")
