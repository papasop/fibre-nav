#!/usr/bin/env python3
"""Compact Colab launcher for MFI unified L1-L5 v2.4.3."""
import argparse
import os
import shutil
import subprocess
...
PACKAGE = "moving_fibre_intelligence_unified_l1_l5_v2_4_3.zip"
...
def main():
    ...
    parser.add_argument("--workdir", default="/content/mfi_unified_v2_4_3")
    ...
    subprocess.check_call(["sha256sum", "-c", sums.name], cwd=source)
    ...
    results.mkdir()
    print("[MFI v2.4.3] frozen seeds: 83221, 83251, 83281", flush=True)
    status = run_streamed([
    ...
    target = Path("/content/moving_fibre_intelligence_unified_l1_l5_results_v2_4_3.zip")
